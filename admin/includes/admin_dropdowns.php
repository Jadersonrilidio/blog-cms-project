...
<ul class="nav navbar-right top-nav">
    ...
    <li> <a> Users online: <span class="users-online"> </span> </a> </li>

    <li title="homepage"> <a href="../index.php"> <i class="fa fa-fw fa-home"> </i> Home </a> </li>
    ...
    <li class="dropdown" title="profile">
        ...
        <ul class="dropdown-menu">
            ...
            <li class="divider"> </li>
            <li> <a href="./index.php?page=logout"> <i class="fa fa-fw fa-power-off"> </i> Log Out </a> </li>
